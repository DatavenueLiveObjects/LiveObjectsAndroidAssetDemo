...
public class Notify {
   ...
   */
  static public void  notifcation(Context context, String messageString, Intent intent, int notificationTitle) {
   ...
   */
  static public void toast(Context context, CharSequence text, int duration) {
